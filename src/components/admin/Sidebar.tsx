...
export const adminNav: { section: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/reviews", label: "Reviews", icon: "M12 2.6l2.9 5.9 6.5.9-4.7 4.6 1.1 6.5-5.8-3-5.8 3 1.1-6.5L2.6 9.4l6.5-.9L12 2.6z" },
  ...
  },
  {
    ...
    items: [
      { href: "/admin/notifications", label: "Notifications", icon: "M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 0 1-3.4 0" },
