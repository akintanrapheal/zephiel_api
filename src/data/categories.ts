...
export const categories: Category[] = [
  ...
  { slug: "ecommerce", name: "E-commerce & Multistore", blurb: "Catalogs, orders, inventory, and multi-storefront sync.", icon: "M6 7h12l1.1 12.1a1 1 0 0 1-1 1.1H5.9a1 1 0 0 1-1-1.1L6 7z M9 7V5.6a3 3 0 0 1 6 0V7" },
