    ...
    plans: [
      {
        ...
        requests: "5 stores, 5,000 calls/mo",
        storeLimit: 5,
        rateLimit: "5 req/min",
        features: [
          "Up to 5 connected storefronts",
          "JSON output format",
          "HTTPS encryption",
      ...
      },
      {
        ...
        price: 50,
        unit: "store",
        requests: "25,000 calls/mo",
        rateLimit: "60 req/min per store",
        storeLimit: 0,
        features: [
          "Up to 5 connected storefronts",
          "JSON output format",
      ...
      },
      {
        ...
        features: [
          ...
          "Conflict resolution and field mapping",
          "Priority support",
          "99.99% uptime SLA",
        ],
      },
      {
        ...
        rateLimit: "Custom",
        // 0 means negotiated rather than a fixed ceiling.
        storeLimit: 0,
        features: [
          "Up to 5 connected storefronts",
          "JSON output format",
